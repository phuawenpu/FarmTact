...
export default function IntegratedApp(){
 ...
 {tool==='records'?<Records onClose={close}/>:tool==='knowledge'?<Knowledge onClose={close}/>:tool==='experiments'?(research?<Research onClose={()=>setResearch(false)}/>:<Experiments onClose={close} onResearch={()=>setResearch(true)}/>):tool==='plan'?<Plan onClose={close}/>:<History onClose={close}/>}
 </Suspense>}/>
}
