...
export type ResearchAction = 'say'|'select'|'propose'|'apply'|'discard'|'run'|'cancel_calculation'|'retry_calculation'|'challenge'|'resolve'|'choose'|'configure'|'stop'|'next'
...
export const researchApi={
  ...
  act:(id:string,body:ResearchActionBody)=>mutationRequest<ResearchSession>(`/council-research/${encodeURIComponent(id)}/actions`,body),
