...
def observe_fixture(run_id,budget=None):
    ...
    with DeepSeekGateway.from_config(ROOT/'config/deepseek_runtime.json',budget=budget or RunBudget(max_requests=1,max_reserved_output_tokens=1024,max_wall_seconds=90)) as gateway:
